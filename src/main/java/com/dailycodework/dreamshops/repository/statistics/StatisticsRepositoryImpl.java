...
public class StatisticsRepositoryImpl implements StatisticsRepositoryCustom {
    ...
    @Override
    public List<RevenueStatDTO> getRevenue(String fromDate, String toDate, String groupBy, Long companyId) {
    ...
    @Override
    public List<TopProductDTO> getTopProducts(Long companyId, String fromDate, String toDate, int limit) {
        Map<String, Object> params = new HashMap<>();
        StringBuilder where = new StringBuilder(" where 1=1 ");
    ...
    @Override
    public List<OrderStatusCountDTO> getOrderStatusCount(Long companyId, String fromDate, String toDate) {
        Map<String, Object> params = new HashMap<>();
        StringBuilder where = new StringBuilder(" where 1=1 ");
